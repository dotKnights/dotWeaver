...
export const RUN_TRANSITIONS: Record<RunStatus, readonly RunStatus[]> = {
	[RUN_STATUS.QUEUED]: [RUN_STATUS.PREPARING, RUN_STATUS.FAILED, RUN_STATUS.CANCELED],
	...
	[RUN_STATUS.AWAITING_REVIEW]: [RUN_STATUS.PUSHING, RUN_STATUS.COMPLETED, RUN_STATUS.CANCELED],
